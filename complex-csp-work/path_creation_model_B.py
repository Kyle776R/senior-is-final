...
def shortcut_technique(case_number, agent, nearby_pickup_0, nearby_pickup_1, agents_list, pickups_list,
                    ...
                    if drop_pickup is True:
                        ...
                        if case_number == 2:
                            ...
                            if allow_shortcut is True:
                                shortcut_success = shortcut_technique(case_number, agent,
                                                                      pickups_list[nearby_pickup_indices[0]],
